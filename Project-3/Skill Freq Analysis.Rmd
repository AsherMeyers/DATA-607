...
barplot(articleSort$frequency, main = "Press Mentions of Data Science Skills", xlab = "# of mentions",horiz =TRUE, names.arg = articleSort$skill, col = rainbow(nrow(articleSort)))
...
barplot(twitSort$t_freq[1:15], main = "Twitter's Top 15 Data Science Skill by # of Mentions", xlab = "# of mentions",horiz =TRUE, names.arg = twitSort$skill_title[1:15], las = 2, col = rainbow(15))
par(op)
...
barplot(articleSort$frequency[1:15], main = "The Press's Top 15 Data Science Skill by # of Mentions", xlab = "# of mentions",horiz =TRUE, names.arg = articleSort$skill[1:15], las = 2, cex.names = 0.8, col = rainbow(15))
par(op2)
```
