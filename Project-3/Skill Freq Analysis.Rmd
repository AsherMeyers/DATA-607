...
x <- barplot(top15$frequency, main = "Distribution of Skills", xlab = "skills", ylab="frequency", col=c("darkblue","red"), names.arg=top15$skill)


top15 <- articleSort[1:15, ]
barplot(top15$frequency, main = "Distribution of Skills", xlab = "frequency", ylab="skills", horiz=TRUE, col=c("darkblue","red"), names.arg=top15$skill)


p <- qplot(top15$skill, top15$frequency, data = top15, color = top15$skill)
