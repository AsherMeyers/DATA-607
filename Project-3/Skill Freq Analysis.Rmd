...
barplot(articleSort$frequency, main = "Press Mentions of Data Science Skills", ylab = "# of mentions", names.arg = articleSort$skill, col = rainbow(nrow(articleSort)))
...
barplot(twitSort$t_freq[1:15], main = "Twitter's Top 15 Data Science Skill by # of Mentions", ylab = "# of mentions", names.arg = twitSort$skill_title[1:15], las = 2, col = rainbow(15))
par(op)
...
barplot(articleSort$frequency[1:15], main = "The Press's Top 15 Data Science Skill by # of Mentions", ylab = "# of mentions", names.arg = articleSort$skill[1:15], las = 2, cex.names = 0.8, col = rainbow(15))
par(op2)
```
...
```{r}
p <- qplot(articleSort$skill_name[1:15],articleSort$frequency[1:15], data = articleSort[1:15], color = articleSort$skill_name[1:15])
