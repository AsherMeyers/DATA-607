...
Superficially, it looks like many parking structures, including those in our dataset, use prices to ration supply. But in truth, they use a hodgepodge of both approaches; when prices are sub-optimal and garages get filled up, queuing is being used to allocate spaces.

####Which approach should be used? 
Superficially, making all parking free and thus using a queuing approach maximizes usage of the parking lots, which is one goal of public infrastructure in general. 
